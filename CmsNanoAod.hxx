#ifndef CmsNanoAod_hxx
#define CmsNanoAod_hxx
...
public:
   ...
   MamaCollection(const MamaCollection&) = delete;
...
class Event
{
   ...
   void autogen_nano_classes(const char* file_name);
...
public:
   ...
   MamaCollection* PtrColl(int i) { return m_mama_colls[i]; }

   MamaCollection* PtrColl(const std::string& n) { return m_mama_colls[ m_mama_map[n] ]; }
